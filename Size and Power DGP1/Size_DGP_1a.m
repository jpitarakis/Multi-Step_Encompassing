...
%xlswrite('Montec_DGP1a_size.xlsx',T_10,'dgp1a-chom','A1');
%xlswrite('Montec_DGP1a_size.xlsx',T_10_nw,'dgp1a-nw','A1');
%xlswrite('Montec_DGP1a_size.xlsx',T_10_alrv,'dgp1a-alrv','A1');
%xlswrite('Montec_DGP1a_size.xlsx',T_d_10,'dgp1a-d-chom','A1');
%xlswrite('Montec_DGP1a_size.xlsx',T_d_nw_10,'dgp1a-d-nw','A1');
%xlswrite('Montec_DGP1a_size.xlsx',T_d_alrv_10,'dgp1a-d-alrv','A1');
