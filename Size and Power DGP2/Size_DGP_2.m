...
% k=1 is (N,T)=(100,250) and k=2 is (N,T)=(500,500)

mat1a_T10 = ["$\mu_{0}$","0.30","0.35","0.40","0.45"];
mat2a_T10 = ["","","(N,T)=(100,250)","",""];
mat3a_T10 = ["h=1",size_T1_10(:,:,1,1);"h=4",size_T1_10(:,:,2,1);"h=12", size_T1_10(:,:,3,1);"h=24", size_T1_10(:,:,4,1)];
mat4a_T10 = ["","","(N,T)=(500,500)","",""];
mat5a_T10 = ["h=1",size_T1_10(:,:,1,2);"h=4",size_T1_10(:,:,2,2);"h=12", size_T1_10(:,:,3,2);"h=24", size_T1_10(:,:,4,2)];

T10_all = [mat1a_T10;mat2a_T10;mat3a_T10;mat4a_T10;mat5a_T10];

% nw

mat1a_nw_T10 = ["$\mu_{0}$","0.30","0.35","0.40","0.45"];
mat2a_nw_T10 = ["","","(N,T)=(100,250)","",""];
mat3a_nw_T10 = ["h=1",size_T1_nw_10(:,:,1,1);"h=4",size_T1_nw_10(:,:,2,1);"h=12", size_T1_nw_10(:,:,3,1);"h=24", size_T1_nw_10(:,:,4,1)];
mat4a_nw_T10 = ["","","(N,T)=(500,500)","",""];
mat5a_nw_T10 = ["h=1",size_T1_nw_10(:,:,1,2);"h=4",size_T1_nw_10(:,:,2,2);"h=12", size_T1_nw_10(:,:,3,2);"h=24", size_T1_nw_10(:,:,4,2)];

T10_nw_all = [mat1a_nw_T10;mat2a_nw_T10;mat3a_nw_T10;mat4a_nw_T10;mat5a_nw_T10];

% alrv

mat1a_alrv_T10 = ["$\mu_{0}$","0.30","0.35","0.40","0.45"];
mat2a_alrv_T10 = ["","","(N,T)=(100,250)","",""];
mat3a_alrv_T10 = ["h=1",size_T1_alrv_10(:,:,1,1);"h=4",size_T1_alrv_10(:,:,2,1);"h=12", size_T1_alrv_10(:,:,3,1);"h=24", size_T1_alrv_10(:,:,4,1)];
mat4a_alrv_T10 = ["","","(N,T)=(500,500)","",""];
mat5a_alrv_T10 = ["h=1",size_T1_alrv_10(:,:,1,2);"h=4",size_T1_alrv_10(:,:,2,2);"h=12", size_T1_alrv_10(:,:,3,2);"h=24", size_T1_alrv_10(:,:,4,2)];

T10_alrv_all = [mat1a_alrv_T10;mat2a_alrv_T10;mat3a_alrv_T10;mat4a_alrv_T10;mat5a_alrv_T10];
...
%xlswrite('Montec_DGP2_size.xlsx',T10_all,'dgp2-T10','A1');
%xlswrite('Montec_DGP2_size.xlsx',T10_nw_all,'dgp2-T10nw','A1');
%xlswrite('Montec_DGP2_size.xlsx',T10_alrv_all,'dgp2-T10alrv','A1');
